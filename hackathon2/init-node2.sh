...
ssh IAS-Node-2@52.146.1.189 sudo docker run -d --name platform-manager -p 5001:5001 -e KAFKA_ADDRESS="52.146.2.26" plat-man &
...
ssh IAS-Node-2@52.146.1.189 sudo docker run -d --name sensor-type -e KAFKA_ADDRESS="52.146.2.26" sensor-type &
...
ssh IAS-Node-2@52.146.1.189 sudo docker run -d --name sensor-instance -e KAFKA_ADDRESS="52.146.2.26" sensor-instance &
...
ssh IAS-Node-2@52.146.1.189 sudo docker run -d --name scheduler -e KAFKA_ADDRESS="52.146.2.26" scheduler &
